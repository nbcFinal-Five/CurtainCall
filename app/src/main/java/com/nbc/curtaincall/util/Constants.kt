...
object Constants {
    ...
    const val CLASSIC = "CCCA" //클래식 (서양음악)
    const val KOREA_MUSIC = "CCCC" //국악 (한국음악)
    const val POPULAR_MUSIC = "CCCD" //대중음악
    const val COMPLEX = "EEEA" //복합
    ...
    const val SEARCH_GENRE_FILTER = "searchgenre"
    const val SEARCH_ADDR_FILTER = "searchaddr"
    const val SEARCH_CHILD_FILTER = "searchchild"
}